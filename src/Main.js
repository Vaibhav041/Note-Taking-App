    ...
    return (
        <div className="app-main">
            <div className="app-main-note-edit">
                ...
                <textarea id="body" placeholder="write your note here..." value={activeNote && activeNote.body} onChange={(e) => onEditField("body", e.target.value)} />
            </div>
            <div className="app-main note-preview">
                <h1 className="preview-title">{activeNote && activeNote.title}</h1>
                <RecatMarkdown className="markdown-preview">{activeNote && activeNote.body}</RecatMarkdown>
            </div>
        </div>
    );
};
